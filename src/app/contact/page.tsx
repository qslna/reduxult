          ...
          <div className="grid grid-cols-12 gap-8 items-start max-[1024px]:grid-cols-1 max-[1024px]:gap-16">
            ...
            <div className="contact-info-section col-span-4 max-[1024px]:col-span-1">
              ...
              <div className="space-y-8">
                ...
                {/* 이메일 */}
                <div className="contact-info-card group relative bg-white/[0.02] border border-white/10 rounded-lg p-6">
              ...
              <div className="social-links mt-16">
                ...
                <div className="flex gap-4">
                  <a 
                    ...
                    className="group w-12 h-12 bg-white/10 border border-white/20 rounded-full flex items-center justify-center transition-all duration-300"
                  >
